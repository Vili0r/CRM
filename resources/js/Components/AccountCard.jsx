...
const AccountCard = ({ account }) => {
  return (
    <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg mt-3 mb-3">
        ...
        <div className="flex items-center px-6 py-3 bg-gray-900">
            ...
            <h1 className="mx-3 text-lg font-semibold text-white">{account.name}</h1>
        </div>

        <div className="px-6 py-4">
            <h1 className="text-xl font-semibold text-gray-800">{account.phone_number}</h1>

            <p className="py-2 text-gray-700">{account?.description}</p>
            ...
            <div className="flex items-center mt-4 text-gray-700">
                ...
                <h1 className="px-2 text-sm">{account.industry}</h1>
            </div>
            ...
            <div className="flex items-center mt-4 text-gray-700">
                ...
                <h1 className="px-2 text-sm">{account.city}</h1> <span>, {account.post_code}</span>
            </div>
            ...
            <div className="flex items-center mt-4 text-gray-700">
                ...
                <h1 className="px-2 text-sm">{account.domain}</h1>
            </div>
        </div>
    </div>
  )
